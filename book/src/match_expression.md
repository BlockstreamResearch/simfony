...
However, the variable `x` cannot be deconstructed via pattern matching.
...
Again, variables inside match arms cannot be pattern-matched.
...
Variables can be further deconstructed inside the match arm.
